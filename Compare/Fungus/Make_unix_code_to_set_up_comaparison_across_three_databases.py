...
get_matches_and_write_copy_over_script_first_is_directory(onek_dict, ncbi_dict, onek_path, ncbi_path, onek_ncbi_matched_script_filename,"1k", "ncbi")

# ...for ensembl and ncbi matches
get_matches_and_write_copy_over_script(ensembl_dict, ncbi_dict, ensembl_path, ncbi_path, ensmebl_ncbi_matched_script_filename, "ensembl", "ncbi")

# ...for 1k and ensmebl matches
get_matches_and_write_copy_over_script_first_is_directory(onek_dict, ensembl_dict, onek_path, ensembl_path, onek_ensembl_matched_script_filename, "1k", "ensembl")
